...
export class RequestValidator {
    private static readonly MAX_MESSAGES = Number(process.env.VALIDATOR_MAX_MESSAGES || 50);
    private static readonly MAX_MESSAGE_LENGTH = Number(process.env.VALIDATOR_MAX_MESSAGE_LENGTH || 4000);
    private static readonly MAX_TOKENS = Number(process.env.VALIDATOR_MAX_TOKENS || 4000);
